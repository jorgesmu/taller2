...
public class FactoryInstruccionAddFp extends FactoryInstruccion {

	public FactoryInstruccionAddFp(Map<String, String> labels, Map<String, String> operandos) {
	...
	public String[] getInstrucciones(String[] lineaParseada, String pcActual) throws InstruccionAssemblyInvalidaException {
		...
		String instruccion = new String("6");		
