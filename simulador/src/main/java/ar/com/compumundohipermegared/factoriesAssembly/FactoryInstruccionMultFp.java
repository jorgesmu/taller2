...
public class FactoryInstruccionMultFp extends FactoryInstruccion {

	public FactoryInstruccionMultFp(Map<String, String> labels, Map<String, String> operandos) {
	...
	public String[] getInstrucciones(String[] lineaParseada, String pcActual) throws InstruccionAssemblyInvalidaException {
		...
		String instruccion = new String("D");		
